...
bool set_channel_empty(std::string guild_id)
{
    ...
    bsoncxx::stdx::optional<bsoncxx::document::value> chat_data = chat_collections.find_one(bsoncxx::builder::basic::make_document(bsoncxx::builder::basic::kvp("_id", guild_id)));
